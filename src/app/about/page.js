            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-start">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex gap-2 sm:gap-3 mt-2 sm:mt-4">
                  <a href={`https://facebook.com/${companyInfo.social.facebook}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-600 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform text-sm sm:text-base">
                    <FaFacebook />
                  </a>
                  <a href={`https://instagram.com/${companyInfo.social.instagram}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 bg-pink-600 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform text-sm sm:text-base">
                    <FaInstagram />
                  </a>
                  <a href={`https://twitter.com/${companyInfo.social.twitter}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-400 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform text-sm sm:text-base">
                    <FaTwitter />
                  </a>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="bg-gradient-to-r from-orange-50 to-orange-100/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-xl">
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start">
              ...
              {/* Right Column - Alibaba Store Preview - Responsive */}
              <div className="relative mt-6 lg:mt-0">
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4 sm:p-6 text-white">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-sm sm:text-lg">Asian Clothify Ltd.</h4>
                  ...
                  <div className="p-3 sm:p-4 border-t border-gray-200">
                    <p className="text-xs sm:text-sm font-semibold text-gray-900 mb-2 sm:mb-3">Featured Products</p>
                    <div className="grid grid-cols-3 gap-2">
                      {[1,2,3].map((item) => (
                        <div key={item} className="bg-gray-100 rounded-lg h-12 sm:h-16 flex items-center justify-center text-xs text-gray-400">
                          Product
                        </div>
                      ))}
                    </div>
                ...
                {/* Floating Rating Badge - Responsive */}
                <motion.div 
                  animate={{ y: [0, -10, 0] }}
