          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 -mt-16 sm:-mt-20 relative z-20">
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2 break-words">{companyInfo.phone}</p>
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2 break-words">{companyInfo.email}</p>
