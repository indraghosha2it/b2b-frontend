...
//     filters.maxPrice, 
//     filters.status,
//     filters.isFeatured, // New featured filter
//     filters.sortBy, 
//     currentPage
//   ]);
...
//     // Don't show full page loading for search, just a small indicator
//     if (filters.search) {
...
//       // Include inactive products for moderator (view only, cannot toggle)
...
//     setCurrentPage(1);
//     fetchProducts(); // Immediate fetch when cleared
//   };
...
//   // Product Card Component (Grid View) - No delete or toggle buttons
...
//   // Product Card Component (List View) - No delete or toggle buttons
...
//             <div className="relative h-48 md:h-60 overflow-hidden bg-gray-100 rounded-lg">
//               <img
//                 src={productImages[activeIndex]?.url || productImages[0]?.url || 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500'}
//                 alt={product.productName}
//                 className="w-full h-full object-cover"
...
//                   <button
//                     onClick={() => handleView(product._id)}
//                     className="flex-1 px-4 py-2 bg-[#E39A65] text-white text-sm font-medium rounded-lg hover:bg-[#d48b54] transition-colors flex items-center justify-center gap-2"
//                   >
//                     <Eye className="w-4 h-4" />
//                     View Details
//                   </button>
...
//                   <button
//                     onClick={() => handleEdit(product._id)}
//                     className="flex-1 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-1"
//                   >
//                     <Edit className="w-3.5 h-3.5" />
//                     Update Product
//                   </button>
...
//       {/* Main Content */}
//       <div className="p-6">
//         {/* Search Bar with Instant Search Indicator */}
//         <div className="mb-4">
...
//               className="w-full pl-9 pr-12 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#E39A65] focus:border-transparent outline-none transition"
//             />
//             {filters.search && (
//               <button
//                 onClick={clearSearch}
...
//                 <Loader2 className="w-3 h-3 animate-spin text-[#E39A65]" />
//               </div>
//             )}
//           </div>
...
export default function ModeratorAllProducts() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const queryParams = new URLSearchParams();
      queryParams.append('page', currentPage);
      queryParams.append('limit', 10); // Changed to 10 for better list view
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        {/* Filter Bar - Using external component */}
        <FilterBar 
          filters={filters}
