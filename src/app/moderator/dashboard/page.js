...
const fetchDashboardData = async () => {
  try {
    ...
    let statsUrl = 'https://b2b-backend-rosy.vercel.app/api/moderator/inquiries?limit=10000';
    let recentUrl = 'https://b2b-backend-rosy.vercel.app/api/moderator/inquiries?limit=10';
