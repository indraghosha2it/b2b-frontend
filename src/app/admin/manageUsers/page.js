...
export default function ManageUsers() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://b2b-backend-rosy.vercel.app/api/admin/users?${params}`, {
        headers: {
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await fetch(`https://b2b-backend-rosy.vercel.app/api/admin/users/${deleteModal.userId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://b2b-backend-rosy.vercel.app/api/admin/users/${editModal.user._id}`, {
        method: 'PUT',
        headers: {
