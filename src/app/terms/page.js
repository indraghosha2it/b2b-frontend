...
export default function TermsPage() {
  ...
  const sections = [
      ...
      content: (
        <div className="space-y-6">
          <p className="text-lg text-gray-700 leading-relaxed">
            Welcome to <span className="font-bold text-orange-600">Asian Clothify</span>. By accessing or using our B2B wholesale clothing platform, you agree to be bound by these Terms and Conditions.
          </p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 mt-4">
            <div className="bg-white p-4 rounded-xl border border-gray-200 hover:border-purple-300 transition-colors">
              ...
              <p className="text-gray-600">Refers to Asian Clothify's B2B wholesale clothing website, including all subdomains and associated services.</p>
            </div>
            ...
            <div className="bg-white p-4 rounded-xl border border-gray-200 hover:border-purple-300 transition-colors">
              ...
              <p className="text-gray-600">Refers to B2B customers/retailers who browse products, submit inquiries, and make purchases through the Platform.</p>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <p className="text-gray-700">As a user of our B2B platform, you agree to:</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <p className="text-gray-700">Our B2B platform uses an inquiry-based sales process:</p>
          ...
          <div className="relative z-10 h-full flex items-center container mx-auto px-4">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/20">
                <FaFileContract className="text-orange-400 text-xl" />
              ...
              <p className="text-xl text-gray-200 mb-4">
                The rules and guidelines for using our B2B wholesale platform
              </p>
              ...
              <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8 md:p-10">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  <div className="bg-gradient-to-r from-orange-50 to-orange-100/50 rounded-2xl p-8 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Agreement to Terms</h3>
                    <p className="text-gray-600 max-w-2xl mx-auto mb-6">
                      By using Asian Clothify's B2B platform, you acknowledge that you have read, understood, 
