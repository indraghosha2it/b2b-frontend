...
// // Filter Sidebar Component - Moved OUTSIDE of main component
// const FilterSidebar = ({ 
//   expandedSections, 
//   toggleSection, 
//   categories, 
        ...
        <div>
          ...
          <div className="p-5 pt-3">
             <div className="flex items-start justify-between gap-2 mb-1">
                          <h3 className="text-md font-semibold text-gray-900 line-clamp-2 flex-1" title={product.productName}>
